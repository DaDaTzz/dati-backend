...
import com.da.dati.mapper.QuestionMapper;
import com.da.dati.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appId), ErrorCode.PARAMS_ERROR, "应用id为空");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
