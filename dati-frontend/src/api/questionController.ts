...
/** generatorQuestionByAi POST /api/question/ai_generate */
export async function generatorQuestionByAiUsingPost(
  body: API.AiGeneratorQuestionRequest,
  options?: { [key: string]: any },
) {
...
/** generatorQuestionByAiSSE GET /api/question/ai_generate/sse */
export async function generatorQuestionByAiSseUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.generatorQuestionByAiSSEUsingGETParams,
  options?: { [key: string]: any },
) {
